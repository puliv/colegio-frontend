...
try {
    ...
    // Ajusta el puerto '3000' si tu backend corre en otro
    ...
    // Si todo sale bien, el backend nos devuelve el token JWT
    ...
    // Atrapamos el mensaje de error EXACTO que manda el backend
    if (error.response && error.response.data && error.response.data.msg) {
    setError(error.response.data.msg); // Ej: "Credenciales incorrectas (Email)"
    } else {
